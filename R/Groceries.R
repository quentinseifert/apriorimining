...
#' of probabilistic data modeling for mining association rules. In M. Spiliopoulou,
#' R. Kruse, C. Borgelt, A. Nuernberger, and W. Gaul, editors, From Data and Information
#' Analysis to Knowledge Engineering, Studies in Classification, Data Analysis, and
#' Knowledge Organization, pages 598–605. Springer-Verlag.
"Groceries"
